    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('doctor', 'Doctor'), ('customer', 'Customer'), ('admin', 'Admin')], default='doctor', max_length=50, verbose_name='user role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beginning_of_the_experience', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1923), django.core.validators.MaxValueValidator(2023)])),
